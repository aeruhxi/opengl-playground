...
pub fn create_material(vertex_source: &str, fragment_source: &str) -> Material {
...
impl Material {
    ...
    pub fn set_float(&self, name: &str, value: f32) {
        self.program.get_uniform_location(name).set1f(value);
    }

    pub fn set_integer(&self, name: &str, value: i32) {
        self.program.get_uniform_location(name).set1i(value);
    }

    pub fn set_vector2f(&self, name: &str, value: Vec2) {
        self.program.get_uniform_location(name).set2f(value.x, value.y);
    }

    pub fn set_vector3f(&self, name: &str, value: Vec3A) {
        self.program.get_uniform_location(name).set3f(value.x, value.y, value.z);
    }

    pub fn set_vector4f(&self, name: &str, value: Vec4) {
        self.program
            .get_uniform_location(name)
            .set4f(value.x, value.y, value.z, value.w);
    }
